...
extract:
	python main.py extract "https://data.cityofnewyork.us/resource/c3uy-2p5r.csv?$limit=200000" "air_quality.csv"
...
all: install format lint test extract transfer_and_load query
